                            ...
                            <div class="accordion" id="accordionFaq">
                                <div class="section pt-0">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionFaq">
                                            <div class="accordion-body">
                                                <p> We offer a wide variety of trophies, including sports trophies, academic awards, corporate recognition trophies, and custom trophies tailored to your specific needs..</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item ">
                                        <h2 class="accordion-header" id="headingThree">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Can I customize the trophies with my own design or logo</button>
                                        </h2>
                                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionFaq">
                                            <div class="accordion-body">
                                                <p> Yes, we offer customization services. You can personalize trophies with your own designs, logos, and engraving to make them unique and special for your event or occasion.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingFour">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">How long does it take to receive a customized trophy order?</button>
                                        </h2>
                                        <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionFaq">
                                            <div class="accordion-body">
                                                <p>The production time for customized trophies depends on the complexity of the design and the quantity ordered. We strive to fulfill orders as quickly as possible, and our team will provide you with an estimated timeline when you place your order..</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingFive">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">Can I order trophies in bulk for a team or an event?</button>
                                        </h2>
                                        <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionFaq">
                                            <div class="accordion-body">
                                                <p> Yes, we welcome bulk orders. We offer discounts for large quantity orders, making it convenient for sports teams, schools, and organizations to recognize multiple individuals at once.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item ">
                                        <h2 class="accordion-header" id="headingSix">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">What is the best way to place an order?</button>
                                        </h2>
                                        <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionFaq">
                                            <div class="accordion-body">
                                                <p>You can place an order through our whatsapp catalogue, website, visit our physical store, or contact our customer service team directly. Our friendly staff is ready to assist you in choosing the right trophies for your needs.</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingSeven">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">What payment methods do you accept?</button>
                                    </h2>
                                    <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#accordionFaq">
                                        <div class="accordion-body">
                                            <p>We accept various payment methods, including credit cards, debit cards, and other secure online payment options. Our goal is to make the ordering process as convenient as possible for our customers.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingEight">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">Do you offer rush order services for last-minute events?</button>
                                    </h2>
                                    <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight" data-bs-parent="#accordionFaq">
                                        <div class="accordion-body">
                                            <p> Yes, we understand that sometimes orders are needed urgently. We offer rush order services for situations that require a quicker turnaround. Please contact us directly to discuss your specific needs.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingNight">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNight" aria-expanded="false" aria-controls="collapseNight">Can I return or exchange a trophy if there is an issue?</button>
                                    </h2>
                                    <div id="collapseNight" class="accordion-collapse collapse" aria-labelledby="headingNight" data-bs-parent="#accordionFaq">
                                        <div class="accordion-body">
                                            <p>We strive for customer satisfaction. If there is an issue with your order, please contact us promptly. We will work with you to address any concerns and, if necessary, discuss return or exchange options.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item ">
                                    <h2 class="accordion-header" id="headingTen">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">Do you offer bulk discounts for large orders?</button>
                                    </h2>
                                    <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen" data-bs-parent="#accordionFaq">
                                        <div class="accordion-body">
                                            <p>Absolutely! We value our customers, and bulk orders may qualify for discounts. Please reach out to our sales team or use the provided discount codes during checkout for more information.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item ">
                                    <h2 class="accordion-header" id="headingEleven">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEleven" aria-expanded="false" aria-controls="collapseTen">What is your return policy?</button>
                                    </h2>
                                    <div id="collapseEleven" class="accordion-collapse collapse" aria-labelledby="headingEleven" data-bs-parent="#accordionFaq">
                                        <div class="accordion-body">
                                            <p>We want you to be completely satisfied with your trophies. If for any reason you're not happy with your order, please contact us within 2 days of receiving it, and we'll guide you through the return process.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item ">
                                    <h2 class="accordion-header" id="headingTwele">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwele" aria-expanded="false" aria-controls="collapseTen">Can I see a proof of the trophy before it is finalized?</button>
                                    </h2>
                                    <div id="collapseTwele" class="accordion-collapse collapse" aria-labelledby="headingTwele" data-bs-parent="#accordionFaq">
                                        <div class="accordion-body">
                                            <p>Yes, we can provide a digital proof for your approval before finalizing the order. This ensures that you are satisfied with the design and engraving details.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item ">
                                    <h2 class="accordion-header" id="headingThirteen">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirteen" aria-expanded="false" aria-controls="collapseTen">Can you ship trophies to locations outside your local area?</button>
                                    </h2>
                                    <div id="collapseThirteen" class="accordion-collapse collapse" aria-labelledby="headingThirteen" data-bs-parent="#accordionFaq">
                                        <div class="accordion-body">
                                            <p>Yes, we offer shipping services for trophies to locations both within and outside our local area. Shipping costs and delivery times may vary, so please inquire about the details when placing your order.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
