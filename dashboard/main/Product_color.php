        ...
        $(document).ready(function () {
            ...
            $('#submit').click(function () {
                ...
                if (proColor == "") {
                    ...
                    fd.append("color", proColor);

                    $.ajax({
                        url: '../main/ajax/color/create_color.php',
                        data: fd,
                        type: 'post',
                        contentType: false,
                        processData: false,
                    ...
                    success: function (response) {
                        ...
                        if (result.status == 'Success') {
                            ...
                            data.map(function (value) {
                                ...
                                console.log(Edit_ID);
                                var editButton =
                                 `<a  data-bs-toggle="modal" data-bs-target="#edit" class='text-success me-2 edit_Size'><i class="bi bi-pencil-fill h6"></i></a>`;
