<?php
    ...
    function getTotalItems() {
        ...
        $result = mysqli_query($conn, "SELECT COUNT(id) AS total FROM product_data WHERE `status`='Active' AND `product_type`='medal'");
